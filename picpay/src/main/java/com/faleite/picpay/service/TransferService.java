...
import com.faleite.picpay.repository.TransferRepository;
...
public class TransferService {
    ...
    public Transfer transfer(Long payerId, Long payeeId, BigDecimal valueTransfer){
        ...
        uPayee.setBalance(uPayer.getBalance().add(valueTransfer));
        ...
        notificationService.notify(uPayer, "You sent a transfer of: " +valueTransfer);
